define([
    ...
    return declare([GraphicsLayer], {
        ...
        _inExtent: function() {
            ...
            /*var normalizeExtents = this._map.extent.normalize();
            var ext1, ext2;
            if (normalizeExtents.length > 1) {
                ext1 = normalizeExtents[0];
                ext2 = normalizeExtents[1];
            } else {
                ext1 = normalizeExtents[0];
                ext2 = normalizeExtents[0];
            }*/
            ...
            while (len--) {
                ...
                // if (cached && (ext1.contains(cached.geometry) || ext2.contains(cached.geometry))) {
                    valid.push(cached);
                }
            }
